...
class StandardEngineParamsDialog(QDialog):
    ...
    def getEngineParameters(self) -> StandardEngineParams:
        s = DEFAULT_ENGINE_PARAMS   # TODO: would be nice to have an empty obj
...
if __name__ == '__main__':
    ...
    print("exec() done")
    params = dlg._cfg
    dlg2 = StandardEngineParamsDialog(params)
    dlg2.exec()
    # app.exec_()
